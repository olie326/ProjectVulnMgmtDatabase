export type asset = {
  ...
  export class Asset implements asset {
    ...
    constructor(props: Partial<asset> = {}) {
        ...
        this.first_observed = props.first_observed || "";
        this.is_licensed = props.is_licensed || "";
        this.is_public = props.is_public || "";
        this.last_authenticated_scan_time = props.last_authenticated_scan_time || "";
        this.last_licensed_scan_time = props.last_licensed_scan_time || "";
        this.last_observed = props.last_observed || "";
        this.last_scan_time = props.last_scan_time || "";
        ...
        this.date_record_added = props.date_record_added || "";
